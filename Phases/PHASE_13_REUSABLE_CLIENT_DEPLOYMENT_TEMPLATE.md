...
- Create a deterministic fresh-client provisioning procedure covering Supabase, Cloudflare Pages, SendPulse, Bricks, DNS, backup, and client ownership steps.
...
- Prove the Cloudflare Pages production build/artifact locally using the repository's deployment-compatible build path; do not require publication.
...
| **P13.3 Deployment Artifact Readiness** | Cloudflare Pages-compatible production build/artifact is reproducible locally without publication. |
...
| `P13-T02` | Local production build | Build | The Cloudflare Pages-compatible production build/artifact completes locally using the documented command and environment contract without publication. |
