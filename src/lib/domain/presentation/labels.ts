...
const activityEventLabels: Record<string, string> = {
	...
	quote_item_product_added: 'Product added to Quote',
	quote_item_product_refreshed: 'Product snapshot refreshed',
	quote_item_product_reviewed: 'Product changes reviewed',
