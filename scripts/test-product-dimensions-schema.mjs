...
sql(
	[
		...
		'\t\t\'[{"key":"width","label":"Width","unit":"mm","required":true,"value":"1.23456"}]\'::jsonb,',
		'\t\t\'[{"key":"width","label":"Width","unit":"mm","required":true,"value":"100000.0001"}]\'::jsonb,',
		"\t\tjsonb_build_array(jsonb_build_object('key', 'width', 'label', repeat('L', 81), 'unit', 'mm', 'required', true, 'value', '1500'))::jsonb,",
